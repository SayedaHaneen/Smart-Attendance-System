...
<nav class="navbar navbar-expand-lg app-navbar sticky-top shadow-sm py-2">
    <div class="container-fluid px-3 px-md-4" style="max-width: 1400px; margin: 0 auto;">
        ...
        <!-- Right Utilities (Theme Toggle & Hamburger Button) - Visible on All Screens -->
        <div class="d-flex align-items-center gap-2 ms-auto">
            ...
            <button class="btn border-0 text-main p-1.5 rounded-circle" type="button" data-bs-toggle="offcanvas" data-bs-target="#adminNavbarOffcanvas" aria-controls="adminNavbarOffcanvas" style="width: 36px; height: 36px; display: inline-flex; align-items: center; justify-content: center; background: var(--bg-body);" title="Menu">
...
<!-- Bootstrap Offcanvas Menu (Width 280px, Slides from Left) - Active on Desktop & Mobile -->
<div class="offcanvas offcanvas-start" tabindex="-1" id="adminNavbarOffcanvas" aria-labelledby="offcanvasLabel" style="width: 280px;">
